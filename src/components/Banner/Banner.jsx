            ...
            <div className="container grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0 gap-12">
                ...
                <div className="relative">
                    <motion.img
                        ...
                        className="w-[300px] md:w-[400px] mx-auto relative z-10" src={BannerImg} alt="" />
                    <motion.img
                        initial={{ opacity: 0, y: -100, rotate: -180, scale: 0 }}
                        whileInView={{ opacity: 1, y: 0, rotate: 0, scale: 1 }}
                        transition={{ duration: 0.8, delay: 0.2, ease: easeInOut }}
                        className="absolute bottom-0 z-0" src={Splash} alt="" />
                </div>
                ...
                <div className="flex flex-col justify-center">
                    <div className="text-center md:text-left space-y-4 font-semibold">
                        ...
                        <motion.p
                            ...
                            initial="hidden"
                            whileInView="show"
                            className="text-gray-500">Fanta brings a vibrant flavors and effervescent fun to your day! Whether you're looking to quench your thirst with a testy orange, tangy lemon, or one of our many other fruit-inspired flavors, Fanta is your go-to drink for a refreshing and exciting experience. Dive in to the world of Fanta and let every ship spark your senses with its bold, bubbly, and refreshing taste!</motion.p>
                        <motion.button
                            variants={fadeUp(1.1)}
                            initial="hidden"
                            whileInView="show"
